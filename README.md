...
Для того щоб позбутися цього обмеження, прошу підтримайте мене на ByMeACoffee:
...
З вашою підтримкою я зможу продовжити роботу по інтегріції проекта в Home assistant, наприклад додам вивід результату в mqtt, чи створю сенсор розпізнавання. Поки напишіть мені, і я поділюся інструкцією, як встановити сервер розпізнавання облич в HAOS що зберігає дані облич при перезавантаженні.
Ваша підтримка спрямована на виживання моєї сім'ї в умовах війни в Україні і 
